...
export default function createCrowd({ root, avatars = [], events, reducedMotion, navigation }) {
  ...
  const stats = Object.fromEntries([['state', 'mood'], ['stress', '0.00'], ...ACTIONS.map(a => [a, 0])]);
